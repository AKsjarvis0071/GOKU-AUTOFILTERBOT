...
BOT_TOKEN = environ.get('BOT_TOKEN', "6358263734:AAHrdft_E7CsHG2SmIsbOR5Ncl0hEpKb_s4")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', ' -1001827341051').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001877364689')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://JackSparrow:JackSparrow@cluster0.sfmjldk.mongodb.net/?retryWrites=true&w=majority")
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/elitecraft_studios')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/elitecraft_tutorial')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello Nanbha and Nanbis ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001980557912'))
...
URL = "https://thalapathy-s8ws.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://thalapathy-s8ws.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://thalapathy-s8ws.onrender.com/".format(FQDN)
else:
    URL = "https://thalapathy-s8ws.onrender.com/".format(FQDN)
